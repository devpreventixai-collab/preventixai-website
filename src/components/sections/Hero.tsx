...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-br from-blue-200 to-indigo-200 rounded-full opacity-20 blur-sm"></div>
      <div className="absolute bottom-40 left-20 w-24 h-24 bg-gradient-to-br from-emerald-200 to-teal-200 rounded-full opacity-30 blur-sm"></div>
      <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-orange-200 to-yellow-200 rounded-full opacity-25 blur-sm"></div>

      {/* Product showcase area - right side */}
      <div className="absolute right-8 top-1/2 transform -translate-y-1/2 w-1/2 max-w-lg h-96 lg:h-[500px]">
        <div className="w-full h-full relative">
          ...
          <div className="absolute -top-8 -left-8 w-32 h-32 rounded-xl overflow-hidden shadow-xl bg-white/95 backdrop-blur-sm border border-white/60">
            <img 
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            {/* Main headline */}
            <h1 className="text-slate-800 mb-8">
              <div className="text-6xl lg:text-7xl font-bold leading-tight mb-4">
                Safety is priority.
              </div>
            ...
            {/* CTA section */}
            <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-0 mb-8">
              <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden min-w-0 max-w-md border border-white/50">
                <input
                  type="email"
                  placeholder="What's your work email?"
                  className="flex-1 px-6 py-4 text-slate-800 placeholder-slate-500 border-0 focus:outline-none min-w-0 bg-transparent"
                />
                <button className="bg-gradient-to-r from-orange-400 to-amber-400 hover:from-orange-500 hover:to-amber-500 text-white font-semibold px-8 py-4 transition-all duration-200 whitespace-nowrap shadow-lg">
      ...
      {/* Bottom accent - softer approach */}
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-300 to-amber-300 transform rotate-45 translate-x-16 translate-y-16 opacity-20 blur-sm"></div>
      <div className="absolute bottom-10 right-10 w-16 h-16 bg-gradient-to-br from-blue-300 to-indigo-300 rounded-full opacity-30 blur-sm"></div>
    </section>
  );
};
